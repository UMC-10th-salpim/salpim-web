...
const MyPageMenu = () => {
  ...
  return (
    <main className="mypage-content gap-7">
      {/* 인사 카드 */}
      <div className="mypage-card relative flex min-h-[124px] items-center pl-[112px] pr-3">
        <img
          src="/characters/salpimi_Hi.png"
          alt="인사하는 살피미"
          className="absolute left-0 top-2 h-[132px] w-[132px] object-contain"
        />
        ...
        <div className="overflow-hidden rounded-[18px] border-2 border-[#FFD29E] bg-white">
          <div className="flex min-h-[76px] items-center gap-3 px-4 py-3">
            ...
            <div className="min-w-0 flex-1">
              <p className="text-[18px] font-extrabold text-[#613212]">찜한 혜택 알림 표시</p>
