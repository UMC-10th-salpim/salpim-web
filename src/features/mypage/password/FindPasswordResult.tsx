...
const FindPasswordResult = ({ onChangePassword }: FindPasswordResultProps) => {
  return (
    <main className="mypage-content gap-6 text-center">
      <h2 className="text-[26px] font-extrabold text-[#43230F]">본인 확인이 완료됐어요!</h2>

      <div className="mypage-card self-center p-5">
        <p className="text-[21px] font-extrabold leading-[1.4] text-[#FF7A32]">
      ...
      <button
        ...
        className={`${primaryButton} !mt-auto !min-h-16 !flex-none !text-[26px]`}
      >
        새 비밀번호로 바꾸기
      </button>
    </main>
