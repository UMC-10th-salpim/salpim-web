...
const BenefitCard = ({id, category, icon, title, className=''} : BenefitCardProps) => {
  ...
  return (
    <div>
      <Card className={`flex items-start gap-3 !bg-[#FBE3BF] !shadow-none !border-none ${className}`}>
        <div className="w-16 h-16 rounded-full bg-[#FAF8F3] flex items-center justify-center shrink-0 self-center">
